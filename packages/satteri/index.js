  ...
  if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH) {
    ...
    if (process.arch === 'arm64') {
      ...
      try {
        ...
        if (bindingPackageVersion !== '0.10.5' && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0') {
          throw new Error(`Native binding package version mismatch, expected 0.10.5 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`)
        }
        return binding
      } catch (e) {
        loadErrors.push(e)
...
if (!nativeBinding || forceWasi) {
  ...
  if (!wasiBindingLoaded && (!__napiWasiFlavorRequested || __napiWasiFlavor === 'wasm32-wasi')) {
    ...
    try {
      candidateError = __napiWasiResolveCandidate('./satteri_napi.wasi.cjs', false, ['./satteri_napi.wasm32-wasi.debug.wasm', './satteri_napi.wasm32-wasi.wasm'])
  ...
  if (!wasiBindingLoaded && (!__napiWasiFlavorRequested || __napiWasiFlavor === 'wasm32-wasip1')) {
    ...
    let candidateFailed = false
    try {
      candidateError = __napiWasiResolveCandidate('./satteri_napi.wasip1.cjs', false, ['./satteri_napi.wasm32-wasip1.debug.wasm', './satteri_napi.wasm32-wasip1.wasm'])
      candidateFailed = candidateError !== null
      if (!candidateFailed) {
        wasiBinding = require('./satteri_napi.wasip1.cjs')
        nativeBinding = wasiBinding
        wasiBindingLoaded = true
      }
    } catch (err) {
  ...
  if (!wasiBindingLoaded && (!__napiWasiFlavorRequested || __napiWasiFlavor === 'wasm32-wasi')) {
    ...
    let candidateFailed = false
    try {
      candidateError = __napiWasiResolveCandidate('@bruits/satteri-wasm32-wasi', true, undefined)
      candidateFailed = candidateError !== null
      if (!candidateFailed) {
        if (process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0') {
          const bindingPackageVersion = require('@bruits/satteri-wasm32-wasi/package.json').version
          if (bindingPackageVersion !== '0.10.5') {
            throw new Error(`WASI binding package version mismatch, expected 0.10.5 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`)
          }
        }
  ...
  if (!wasiBindingLoaded && (!__napiWasiFlavorRequested || __napiWasiFlavor === 'wasm32-wasip1')) {
    ...
    let candidateFailed = false
    try {
      candidateError = __napiWasiResolveCandidate('@bruits/satteri-wasm32-wasip1', true, undefined)
      candidateFailed = candidateError !== null
      if (!candidateFailed) {
        if (process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0') {
          const bindingPackageVersion = require('@bruits/satteri-wasm32-wasip1/package.json').version
          if (bindingPackageVersion !== '0.10.5') {
            throw new Error(`WASI binding package version mismatch, expected 0.10.5 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`)
          }
        }
        wasiBinding = require('@bruits/satteri-wasm32-wasip1')
        nativeBinding = wasiBinding
        wasiBindingLoaded = true
      }
    } catch (err) {
...
export { parseHastWire }
export { parseMdastWire }
export { parseToHtml }
export { renderHandle }
export { renderHastOpstream }
