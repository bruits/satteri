...
if (__nodeFs.existsSync(__wasmDebugFilePath)) {
  ...
  const __wasiPackageEntry = require.resolve('@bruits/satteri-wasm32-wasi')
  const __packagedWasmFilePath = __nodePath.join(
    __nodePath.dirname(__wasiPackageEntry),
    'satteri_napi.wasm32-wasi.wasm',
  )
  if (!__nodeFs.existsSync(__packagedWasmFilePath)) {
    throw new Error(
      '@bruits/satteri-wasm32-wasi is installed but is missing satteri_napi.wasm32-wasi.wasm.',
    )
  }
...
module.exports.createHastHandleWithFrontmatter = __napiModule.exports.createHastHandleWithFrontmatter
...
module.exports.createMdxHastHandleWithFrontmatter = __napiModule.exports.createMdxHastHandleWithFrontmatter
