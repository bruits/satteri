...
export declare function parseHastWire(source: string, parseOptions: number, convertOptions: JsConvertOptions | undefined | null, mdx: boolean, trackPositions?: boolean | undefined | null): Uint8Array

/** One boundary crossing instead of create + serialize + drop; only the plugin path needs a live handle. */
export declare function parseMdastWire(source: string, parseOptions: number, mdx: boolean, trackPositions?: boolean | undefined | null): Uint8Array
