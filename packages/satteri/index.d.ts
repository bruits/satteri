 ...
 */
export declare function applyCommandsAndCompileHandle(handle: HastHandle, commandBuf: Uint8Array, options?: JsMdxOptions | undefined | null): string
 ...
 */
export declare function applyCommandsAndRenderHandle(handle: HastHandle, commandBuf: Uint8Array): string
 ...
 * NAPI roundtrip.
 */
export declare function applyMdastCommandsAndConvertAndCompile(handle: MdastHandle, commandBuf: Uint8Array, options?: JsMdxOptions | undefined | null): MdxJsOneShot
 ...
 */
export declare function applyMdastCommandsAndConvertAndRender(handle: MdastHandle, commandBuf: Uint8Array): MarkdownHtmlOneShot
 ...
 */
export declare function markdownToHtmlFast(source: string, features?: JsFeatures | undefined | null): MarkdownHtmlOneShot
 ...
 */
export declare function mdxToJsFast(source: string, features?: JsFeatures | undefined | null, options?: JsMdxOptions | undefined | null): MdxJsOneShot
