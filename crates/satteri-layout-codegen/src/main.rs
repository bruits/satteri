...
fn main() {
    ...
    let napi_rs = root.join("crates/satteri-napi-binding/src/generated");
    let property_rs = root.join("crates/satteri-property-info/src/generated");
    ...
    write(&napi_rs.join("mod.rs"), NAPI_MOD_RS);
    write(&napi_rs.join("parse_options.rs"), &emit::parse_options_rs());

    write(&property_rs.join("mod.rs"), PROPERTY_MOD_RS);
    write(
        &property_rs.join("tables.rs"),
        &emit_property_tables::property_tables_rs(property_schema::HTML, property_schema::SVG),
    );
...
const NAPI_MOD_RS: &str = "//! @generated by `cargo run -p satteri-layout-codegen`. Do not edit by hand.\n\n\
    mod parse_options;\n";

const PROPERTY_MOD_RS: &str = "//! @generated by `cargo run -p satteri-layout-codegen`. Do not edit by hand.\n\n\
