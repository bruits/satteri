...
pub fn mdast_arena_to_hast_arena(source: &Arena<Mdast>) -> Arena<Hast> {
    mdast_arena_to_hast_arena_impl(source, None)
}
...
pub fn mdast_arena_to_hast_arena_into(source: &Arena<Mdast>, reuse: Arena<Hast>) -> Arena<Hast> {
    mdast_arena_to_hast_arena_impl(source, Some(reuse))
}

fn mdast_arena_to_hast_arena_impl(source: &Arena<Mdast>, reuse: Option<Arena<Hast>>) -> Arena<Hast> {
