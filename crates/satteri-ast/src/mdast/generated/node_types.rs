...
impl MdastNodeType {
    pub fn from_u8(v: u8) -> Option<Self> {
        match v {
            ...
            35 => Some(MdastNodeType::DescriptionList),
            36 => Some(MdastNodeType::DescriptionTerm),
            37 => Some(MdastNodeType::DescriptionDetails),
            38 => Some(MdastNodeType::Custom),
    ...
    pub fn name(self) -> &'static str {
        match self {
            ...
            MdastNodeType::DescriptionList => "descriptionList",
            MdastNodeType::DescriptionTerm => "descriptionTerm",
            MdastNodeType::DescriptionDetails => "descriptionDetails",
            MdastNodeType::Custom => "custom",
    ...
    pub fn from_name(name: &str) -> Option<Self> {
        Some(match name {
            ...
            "descriptionList" => MdastNodeType::DescriptionList,
            "descriptionTerm" => MdastNodeType::DescriptionTerm,
            "descriptionDetails" => MdastNodeType::DescriptionDetails,
            "custom" => MdastNodeType::Custom,
